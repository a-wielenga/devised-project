...
def add_shift_to_calendar(parent, column, row, colour, employee, time_text):
...
for cat in categories:
    ...
    for col in range(len(dates)):
        tk.Label(calendar_frame, text="", borderwidth=1, relief="solid",
                 width=12, height=3).grid(row=current_row, column=col, sticky="nsew")
...
add_shift_to_calendar(
    calendar_frame,
    column=1,
    row=category_shift_rows["Team Leader"],
    colour=shift_background_colour,
